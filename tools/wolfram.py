...
funding_url: https://github.com/roryeckel/open-webui-wolframalpha-tool
description: These tools can call the WolframAlpha API to query the knowledge engine. This engine can answer a wide variety of world knowledge questions and complex mathematical formuli. It also provides real time data.
version: 0.2.0
"""
